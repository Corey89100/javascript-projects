...
if (fuelLevel <= 5000 || engineTemperature > 2500) {
        console.log('Check fuel fuelLevel. Engines running hot.')
}   
...
if (fuelLevel <1000 || engineTemperature > 3500 || engineIndicatorLight === 'red blinking') {
        console.log ("ENGINE FAILURE IMMINENT, EVREYBODY RUN YALL!!!")
}
//f) Otherwise, print "Fuel and engine status pending..." 
else{
        console.log('fuel and engine status pending...')
}
// Code 5a - 5f here: Just saw this can resubmit if the placement is points off.
...
if (commandOverride = false) {
    console.log('shuttle launch if fuel and engine check ok') 
} else if (commandOverride = true) {
        console.log('shuttle launch regardless of engine and fuel status.')
}
